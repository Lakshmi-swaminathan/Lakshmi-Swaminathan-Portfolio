  ...
  return (
    <EducationContainer id="education">
      ...
      <EducationItemsContainer>
        <EducationItem>
          <UniversityLogo src="../assets/images/Purdue_logo.png" alt="Purdue University Logo" />
        ...
        <EducationItem>
          <UniversityLogo src="../assets/images/Sastra_Logo.jpeg" alt="Sastra University Logo" />
