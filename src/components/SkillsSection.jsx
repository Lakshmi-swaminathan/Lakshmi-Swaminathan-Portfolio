...
const SkillsSection = () => {
  return (
    <SkillsContainer id="skills">
      ...
      <SkillsList>
        <SkillCategory>
          <CategoryIcon src="/asset/images/Laptop.png" alt="Programming Languages Icon" />
          <CategoryInfo>
        ...
        <SkillCategory>
          <CategoryIcon src="/asset/images/Web_Tech.jpg" alt="Web Technologies Icon" />
          <CategoryInfo>
        ...
        <SkillCategory>
          <CategoryIcon src="/asset/images/Database.png" alt="Database Technologies Icon" />
          <CategoryInfo>
        ...
        <SkillCategory>
          <CategoryIcon src="/asset/images/Software.png" alt="Software Icon" />
          <CategoryInfo>
