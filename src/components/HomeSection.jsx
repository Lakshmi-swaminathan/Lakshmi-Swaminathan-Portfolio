...
const HomeSection = () => {
  return (
    <HomeContainer id="home">
      <ContentContainer>
        <HomeImage src="../assets/images/Lakshmi.jpg" alt="Lakshmi Swaminathan" />
        ...
        <DownloadButton href="../assets/Lakshmi_Swaminathan_Resume.pdf" download>
          Download Resume
        </DownloadButton>
      </ContentContainer>
      <IconsContainer>
        <IconLink href="https://github.com/Lakshmi-swaminathan" target="_blank" rel="noopener noreferrer">
          <IconImage src="../assets/images/github-mark-white.png" alt="GitHub" />
        </IconLink>
        <IconLink href="https://www.linkedin.com/in/lakshmi-swaminathan-g/" target="_blank" rel="noopener noreferrer">
          <IconImage1 src="../assets/images/Linkedin_Logo_biggest.png" alt="LinkedIn" />
        </IconLink>
