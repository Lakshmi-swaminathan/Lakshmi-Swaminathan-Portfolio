  ...
  return (
    <EducationContainer id="education">
      ...
      <EducationItemsContainer>
        <EducationItem>
          <UniversityLogo src={`${process.env.PUBLIC_URL}/images/Purdue_logo.png`}  alt="Purdue University Logo" />
        ...
        <EducationItem>
          <UniversityLogo src={`${process.env.PUBLIC_URL}/images//Sastra_Logo.jpeg`} alt="Sastra University Logo" />
